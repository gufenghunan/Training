...
@ComponentBuilder(value = { "com.training.mvc.builder.TrainingOtherTableBuilder" })
public class TrainingOtherTableBuilder extends AbstractComponentBuilder {

	private final static String tableId = "com.training.mvc.builder.TrainingOtherTableBuilder";
